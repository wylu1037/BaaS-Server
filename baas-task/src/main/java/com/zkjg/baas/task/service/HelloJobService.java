...
public class HelloJobService implements IHelloJobService {
    ...
    @Override
    public BaseResult<String> registerSayHelloJob(String language, String author, String content) {
        log.info("[HelloJobService] registerSayHelloJob() called with: language = {}, author = {}, content = {}",
        ...
        log.info("[HelloJobService] registerSayHelloJob() completed addTask, return result = {}",
